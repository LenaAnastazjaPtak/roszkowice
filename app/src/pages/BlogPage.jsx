...
const posts = [
  { img: '/images/blog1.jpg', day: '05', month: 'kwiecień', year: '2016', title: 'Lorem ipsum dolor sit amet', author: 'Tomasz Antoni', comments: 17 },
  { img: '/images/blog2.jpg', day: '24', month: 'marzec', year: '2016', title: 'Consectetur adipiscing elit', author: 'Tomasz Antoni', comments: 6 },
  { img: '/images/blog3.jpg', day: '09', month: 'maj', year: '2016', title: 'Sed do eiusmod tempor', author: 'Tomasz Antoni', comments: 13 },
  { img: '/images/blog4.jpg', day: '20', month: 'czerwiec', year: '2016', title: 'Ut enim ad minim veniam', author: 'Tomasz Antoni', comments: 26 }
]
                ...
                <article key={index} className="type-post">
                  ...
                  <div className="entry-header">
                    ...
                    <div className="entry-meta">
                      ...
                      <div className="post-comment"><Link to="#"><i className="fa fa-commenting-o"></i>{post.comments} komentarzy</Link></div>
                    </div>
                  </div>
                  <div className="entry-content">
                    <p>{excerpt}</p>
                    <Link to="#" title="Czytaj więcej">Czytaj więcej</Link>
                  </div>
                </article>
              ))}
